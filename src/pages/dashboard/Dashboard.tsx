      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="p-6 min-h-[300px]">
          ...
          <div className="space-y-4">
            {[1, 2, 3].map((i) => (
              <div key={i} className="flex items-center p-3 hover:bg-slate-50 rounded-lg transition-colors border border-transparent hover:border-slate-100">
                <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 font-bold text-xs">
                  JD
                </div>
                <div className="ml-4">
                  <p className="text-sm font-medium text-slate-800">New Candidate Added</p>
                  <p className="text-xs text-slate-500">Mohammed Ali for Construction Worker</p>
                </div>
